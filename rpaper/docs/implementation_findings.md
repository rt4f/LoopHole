...
- Scope reviewed:
  - `POC_initial_demo/src/loophole/*`
  - `POC_initial_demo/tests/integration/*`
  - `POC_initial_demo/reports/stablehlo_batch_lift_report_2026-04-06.json`
...
- `POC_initial_demo/src/loophole/lifter.py`
- `POC_initial_demo/src/loophole/affine_extractor.py`
- `POC_initial_demo/src/loophole/sympy_tracer.py`
- `POC_initial_demo/src/loophole/z3_checker.py`
...
- `POC_initial_demo/src/loophole/sketch_library.py`
...
- `POC_initial_demo/tests/integration/test_stablehlo_phase3_ops.py`
- `POC_initial_demo/tests/integration/test_cli_batch_report.py`
- `POC_initial_demo/tests/integration/test_matmul.py`
- `POC_initial_demo/tests/integration/test_demo_script_smoke.py`
