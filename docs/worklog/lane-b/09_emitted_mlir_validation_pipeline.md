...
- `packages/loophole/src/loophole/mlir_validator.py`
...
Added verifier-aware pytest fixture in `packages/loophole/conftest.py`:
...
- `packages/loophole/tests/integration/test_transpose.py`
