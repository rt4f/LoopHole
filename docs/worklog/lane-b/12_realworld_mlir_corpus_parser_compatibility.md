...
New module:
- `packages/loophole/src/loophole/parser_corpus_compat.py`
...
New corpus fixtures:
- `packages/loophole/tests/fixtures/corpus/polygeist_matmul_affine.mlir`
- `packages/loophole/tests/fixtures/corpus/polygeist_conv1d_scf.mlir`
- `packages/loophole/tests/fixtures/corpus/polygeist_dot_iter_args.mlir`
- `packages/loophole/tests/fixtures/corpus/polygeist_if_guarded_store.mlir`
- `packages/loophole/tests/fixtures/corpus/polygeist_affine_apply_indices.mlir`
- `packages/loophole/tests/fixtures/corpus/frontend_no_loop_vectorized.mlir`
...
New script:
- `packages/loophole/scripts/analyze_parser_corpus_compat.py`
