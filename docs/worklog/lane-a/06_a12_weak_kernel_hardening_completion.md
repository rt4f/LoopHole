...
Date: 2026-04-21
Owner: Person A lane
Reference: [12_three_person_parallel_plan_v2_12_weeks.md](../../planning/three-person-execution-plan-v2-12-weeks.md)
...
5. Added dedicated reproducible weak-kernel fixture bundle for A-12 trend snapshots:
   - `packages/loophole/tests/fixtures/a12_weak_kernels/`

## A-12 Metrics Evidence

Week-1 baseline (Sprint-1 closure, 7-kernel baseline set):
1. `research/benchmarks/baselines/sprint1_week1_linalg_20260417.json`
2. `research/benchmarks/baselines/sprint1_week1_stablehlo_20260417.json`

Week-2 A-12 completion snapshots (dedicated weak-kernel suite):
1. `research/benchmarks/baselines/a12_week2_weakkernels_linalg_20260421.json`
2. `research/benchmarks/baselines/a12_week2_weakkernels_stablehlo_20260421.json`
...
Core implementation:
1. `packages/loophole/src/loophole/sketch_library.py`
2. `packages/loophole/src/loophole/emitter.py`
3. `packages/loophole/src/loophole/cli.py`
4. `packages/loophole/scripts/generate_weekly_benchmark_report.py`

Tests:
1. `packages/loophole/tests/integration/test_stablehlo_phase3_ops.py`

Metrics fixtures and snapshots:
1. `packages/loophole/tests/fixtures/a12_weak_kernels/*`
