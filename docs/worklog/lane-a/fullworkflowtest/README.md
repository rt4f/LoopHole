...
- LoopHole CLI: `packages/loophole/.venv/Scripts/loophole.exe`
...
- `packages/loophole/examples/matmul_inplace.c`
...
- `packages/loophole/reports/benchmarks/matmul_inplace_stablehlo.mlir`

### 12. Scale the benchmark kernel to 128x128

Created file:

- `packages/loophole/examples/matmul_inplace_128.c`
...
- `packages/loophole/reports/benchmarks/matmul_cpu_bench_128.c`
