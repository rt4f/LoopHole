...
1. For MLIR-related commands, prefer Docker helper scripts under `packages/loophole/scripts`.
...
- `docs/status/docker-polygeist-delivery-handoff.md`
- `docs/status/project-status.md`
- `docs/planning/future-plan.md`
- `docs/planning/three-person-execution-plan-v2-12-weeks.md`
