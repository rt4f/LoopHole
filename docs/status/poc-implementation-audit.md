...
The core lifter pipeline is implemented in `packages/loophole/src/loophole/lifter.py`:
...
Primary modules:
- Parser: `packages/loophole/src/loophole/affine_extractor.py`
- Sketch catalog: `packages/loophole/src/loophole/sketch_library.py`
- Symbolic matcher: `packages/loophole/src/loophole/sympy_tracer.py`
- Formal checker: `packages/loophole/src/loophole/z3_checker.py`
- Emitters: `packages/loophole/src/loophole/emitter.py`
- Orchestrator: `packages/loophole/src/loophole/lifter.py`
- CLI: `packages/loophole/src/loophole/cli.py`
...
File: `packages/loophole/examples/run_demo.py`
...
Files: `packages/loophole/src/loophole/lifter.py`, `packages/loophole/tests/integration/*`
...
1. Read orchestrator first: `packages/loophole/src/loophole/lifter.py`
2. Read parser data model: `packages/loophole/src/loophole/affine_extractor.py`
3. Read proof limitations: `packages/loophole/src/loophole/z3_checker.py`
4. Read emitter assumptions: `packages/loophole/src/loophole/emitter.py`
