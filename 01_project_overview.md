...
It builds directly on the work of mlirSynth, Tenspiler, Tensorize, and STAGG while targeting novel frontiers that these systems have left open (see [05 — Novel Research Directions](./05_novel_research_directions.md)).
